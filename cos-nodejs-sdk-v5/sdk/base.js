...
function getService(params, callback) {
    ...
    // kailang huang Edit;
    var protocol = this.options.Protocol || (util.isBrowser && this.options.Protocol === 'http:' ? 'http:' : 'https:');
...
function getUrl(params) {
    ...
    var protocol = params.protocol || (util.isBrowser && params.protocol === 'http:' ? 'http:' : 'https:');
    if (!domain) {
